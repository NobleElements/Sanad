...
namespace Sanad.Api.Migrations.Sanad
{
    ...
    [Migration("20260819082851_AddDebtsFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sanad.Api.Models.CalendarEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.CustomApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.Debt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.DebtSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.EventCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.UserSetting", b =>
                {
            ...
            modelBuilder.Entity("Sanad.Api.Models.Whiteboard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sanad.Api.Models.Asset", b =>
                {
                    b.HasOne("Sanad.Api.Models.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("Sanad.Api.Models.CalendarEvent", b =>
                {
                    b.HasOne("Sanad.Api.Models.EventCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Sanad.Api.Models.DebtSnapshot", b =>
                {
                    b.HasOne("Sanad.Api.Models.Debt", "Debt")
                        .WithMany()
