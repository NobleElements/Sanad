...
// Skip files that might already be customized or specifically excluded
const excludeList = [
  'TaskModal.jsx',
  'Tasks.jsx',
  'FileManager',
...
const replacements = [
  ...
  { pattern: /\btext-indigo-700\b(?!\s+dark:text-)/g, replacement: 'text-indigo-700 dark:text-indigo-300' },
